...
# Functions    
def filter_empty_examples(examples):
    '''
...
# filter examples with empty answer('is_impossible=False')
#train_dataset_clean = filter_empty_examples(train_dataset)
valid_dataset_clean = filter_empty_examples(valid_data)
...
torch.save(train_features, 'data/train_v2.pt')
logger.info(f"saved train dataset at data/train_v2.pt")
print("saved train dataset at data/train_v2.pt")

torch.save(valid_features, 'data/valid_v2.pt')
logger.info(f"saved validation dataset at data/valid_v2.pt")
print("saved validation dataset at data/valid_v2.pt")
